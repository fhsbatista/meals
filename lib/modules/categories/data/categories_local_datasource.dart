...
import 'package:meals/modules/categories/data/models/meal_model.dart';
import 'package:meals/modules/categories/domain/entities/meal.dart';

abstract class CategoriesLocalDatasource {
  List<CategoryModel> getCategories();

  List<MealModel> getMealsByCategory(String id);
}
...
class CategoriesLocalDatasourceImpl extends CategoriesLocalDatasource {
  ...
  @override
  List<MealModel> getMealsByCategory(String id) =>
      dummyMeals.where((element) => element.categoriesIds.contains(id)).toList();
}
